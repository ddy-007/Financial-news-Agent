...
class Settings(BaseSettings):
    ...
    #
    # **为什么从 30 调小到 15**：采集间隔也是 30 分钟，于是每轮窗口恒为 60 分钟，
    # 其中**一半是上一轮刚抓过的** —— 那些条目同样要过一遍 LLM 分类。
    # 实测佐证（2026-09-22 22:20 那轮）：抓 290 条 → 相关 218 / 丢弃 72 / 合并 164 /
    # **真正新增只有 54 条（19%）**。调到 15 后窗口 45 分钟，冗余约 33%。
    #
